...
public class RequestAPI {
    ...
    private static String readApiKey() throws IOException {
        return new String(Files.readAllBytes(Paths.get("src/main/java/apikey.txt"))).trim();
    }
